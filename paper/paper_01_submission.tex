...
If the ratio is $1.0$---every constraint group satisfiable---the verdict is \textsc{Verified}.
Anything less is \textsc{Contradiction}.
There is no intermediate threshold, because there is no intermediate truth.
A $90\%$ coherence threshold reintroduces the preference gradient the gate exists to eliminate: the solver does not have preferences, it has proofs.
