...
## Weekend MoE Pipeline Frames

Operational SVG pack for the 1.2B base -&gt; REAP -&gt; 4x0.6B MoE build path:

- [Hyperparameter sheet](weekend_pipeline_01_hyperparams.svg)
- [REAP flow](weekend_pipeline_02_reap_flow.svg)
- [12-hour schedule](weekend_pipeline_03_12h_schedule.svg)
- [Byteword/SAT framing spec](weekend_pipeline_04_byteword_spec.svg)
- [Diagonal-padded expert parallelism](weekend_pipeline_05_diagonal_parallel.svg)

Bridge datasets used between expert specialization and MoE gating:

- [Severian/Internal-Knowledge-Map](https://huggingface.co/datasets/Severian/Internal-Knowledge-Map)
- [Severian/Internal-Knowledge-Map-StoryWriter-RolePlaying](https://huggingface.co/datasets/Severian/Internal-Knowledge-Map-StoryWriter-RolePlaying)
